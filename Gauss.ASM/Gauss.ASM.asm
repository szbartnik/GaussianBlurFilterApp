...
FirstIteration proc args:PARAMS, tempImg:DWORD
...
SecondIteration proc args:PARAMS, tempImg:DWORD
...
ComputeGaussBlur proc args:PARAMS
	...
	invoke FirstIteration, args, tempImg
	invoke SecondIteration, args, tempImg
